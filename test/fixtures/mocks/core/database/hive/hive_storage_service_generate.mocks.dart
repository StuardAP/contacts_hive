...
// in contacts_hive/test/fixtures/mocks/core/database/hive/hive_storage_service_generate.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i4;

import 'package:contacts_hive/core/database/hive/hive_storage_service.dart'
    as _i3;
...
/// A class which mocks [HiveServiceStorage].
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveServiceStorage extends _i1.Mock
    implements _i3.HiveServiceStorage {
  MockHiveServiceStorage() {
  ...
  @override
  void registerAdapter<T>(_i2.TypeAdapter<T>? adapter) => super.noSuchMethod(
        Invocation.method(
          #registerAdapter,
          [adapter],
        ),
  ...
  @override
  _i4.Future<_i2.Box<T>> openBox<T>(String? boxName) => (super.noSuchMethod(
        Invocation.method(
          #openBox,
          [boxName],
        ),
  ...
  @override
  _i2.Box<T> box<T>(String? boxName) => (super.noSuchMethod(
        Invocation.method(
          #box,
          [boxName],
        ),
...
/// A class which mocks [TypeAdapter].
///
/// See the documentation for Mockito's code generation for more information.
// ignore: must_be_immutable
class MockTypeAdapter<T> extends _i1.Mock implements _i2.TypeAdapter<T> {
  MockTypeAdapter() {
    _i1.throwOnMissingStub(this);
  }

  @override
  int get typeId => (super.noSuchMethod(
        Invocation.getter(#typeId),
        returnValue: 0,
      ) as int);

  @override
  T read(_i2.BinaryReader? reader) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [reader],
        ),
